...
var tl = _gsap.gsap.timeline(); //Set element variables
...
},{"gsap":"../node_modules/gsap/index.js"}],"js/skills.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.toolsBtn = exports.backendBtn = exports.frontendBtn = void 0;
//Define button constants
var frontendBtn = document.querySelector("#skill-frontend");
exports.frontendBtn = frontendBtn;
var backendBtn = document.querySelector("#skill-backend");
exports.backendBtn = backendBtn;
var toolsBtn = document.querySelector("#skill-tools"); //Select all buttons

exports.toolsBtn = toolsBtn;
var buttons = document.querySelectorAll(".skill-btn"); //Define skillset list container

var skillList = document.querySelector("#skill-list"); //Define skills

var skills = document.querySelectorAll(".skillset");
var frontendSkills = document.querySelector("#frontend-skills");
var backendSkills = document.querySelector("#backend-skills");
var toolSkills = document.querySelector("#tool-skills"); //Define utility functions

var changeActiveButton = function changeActiveButton(btn) {
...
var changeSkillset = function changeSkillset(skillset) {
